...
import Img1 from '../assets/images/users/golip.jpg';
import Img2 from '../assets/images/users/haikal.jpg';
import Img3 from '../assets/images/users/dika.JPG';
      ...
      teams: [
        {
          id: 1,
          img: Img1,
          name: 'Mohamad Nur Alif Agustian',
          nickname: '#Hipster',
            ...
            <Row>
              <Col lg="12">
                <div className="title-box text-center">
                  <h3 className="title-heading mt-4">The XO Team</h3>
                  <p className="text-muted f-17 mt-3">Meet our team, a brainpower-packed squad with more creativity 
                  <br />than a bucket of glitter and more expertise than a library of tech manuals.</p>
            ...
            <Row className="justify-content-center">
              <Col lg={9}>
                <div className="text-center">
                  <h2>Get Started With <span className="text-primary">Greener.id</span></h2>
