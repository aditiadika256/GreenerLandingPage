...
import LogoDark from '../../assets/images/greener_dark.png';
      ...
      links: [
        {
          ...
          title: "Tech",
          child: [
            { title: "NDVI Cam Package", link: "#" },
            { title: "Solar Panels", link: "#" },
            { title: "Wind Turbine", link: "#" },
          ],
        },
        {
          id: 2,
            ...
            <Row>
              <Col lg={4}>
                <div className="footer-info mt-4">
                  ...
                  <p className="text-muted mt-4 mb-2">A better earth</p>
